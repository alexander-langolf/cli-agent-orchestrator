...
class TestDeleteTerminal:
    """Test delete_terminal coverage including terminal logging and kill_window."""
    ...
    def test_delete_terminal_full_path(self, mock_meta, mock_tmux, mock_pm, mock_db_del):
        """Delete should stop terminal logging, kill window, cleanup provider, delete DB record."""
