...
class TestListSessions:
    ...
    def test_list_sessions_error(self, mock_tmux):
        ...
        mock_tmux.list_sessions.side_effect = Exception("Kitty error")
...
class TestGetSession:
    ...
    def test_get_session_error(self, mock_tmux):
        ...
        mock_tmux.session_exists.side_effect = Exception("Kitty error")

        with pytest.raises(Exception, match="Kitty error"):
            get_session("cao-test")
