...
class TestKimiCliProviderInitialization:
    ...
    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    ...
    @patch("cli_agent_orchestrator.providers.kimi_cli.wait_for_shell", return_value=True)
    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_initialize_kimi_timeout(self, mock_Zellij, mock_wait_shell, mock_wait_status):
    ...
    def test_initialize_with_agent_profile(
        self, mock_load, mock_Zellij, mock_wait_shell, mock_wait_status
    ):
    ...
    @patch("cli_agent_orchestrator.providers.kimi_cli.wait_for_shell", return_value=True)
    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_initialize_sends_kimi_command(self, mock_Zellij, mock_wait_shell, mock_wait_status):
...
class TestKimiCliProviderStatusDetection:
    ...
    def test_get_status_idle(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = _read_fixture("kimi_cli_idle_output.txt")
        provider = KimiCliProvider("term-1", "session-1", "window-1")
        assert provider.get_status() == TerminalStatus.IDLE

    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_get_status_idle_no_thinking(self, mock_Zellij):
    ...
    def test_get_status_completed(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = _read_fixture("kimi_cli_completed_output.txt")
        provider = KimiCliProvider("term-1", "session-1", "window-1")
    ...
    def test_get_status_completed_complex(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = _read_fixture("kimi_cli_complex_response.txt")
        provider = KimiCliProvider("term-1", "session-1", "window-1")
        assert provider.get_status() == TerminalStatus.COMPLETED
    ...
    def test_get_status_processing(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = _read_fixture("kimi_cli_processing_output.txt")
        provider = KimiCliProvider("term-1", "session-1", "window-1")
    ...
    def test_get_status_error_pattern(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = _read_fixture("kimi_cli_error_output.txt")
        provider = KimiCliProvider("term-1", "session-1", "window-1")
        assert provider.get_status() == TerminalStatus.ERROR
    ...
    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_get_status_processing_streaming(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_get_status_completed_long_response_no_bullets(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = processing_output
        assert provider.get_status() == TerminalStatus.PROCESSING
        ...
        mock_Zellij.get_history.return_value = completed_output
        assert provider.get_status() == TerminalStatus.COMPLETED

    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_get_status_latching_persists_after_scrollout(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_get_status_idle_before_any_input(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kimi_cli.zellij_client")
    def test_get_status_processing_latches_flag(self, mock_Zellij):
...
class TestKimiCliProviderMessageExtraction:
    ...
    def test_extract_message_long_response_fallback(self):
        ...
        Zellij capture. The fallback extracts everything before the idle prompt.
        """
        provider = KimiCliProvider("term-1", "session-1", "window-1")
