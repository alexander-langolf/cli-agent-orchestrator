...
class TestPermissionPromptActive:
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_p3_active_injection_delivered(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_p4_active_different_injection_text(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_p8_active_partial_typing(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_p1_active_zero_idle_prompts_after(self, mock_Zellij):
...
class TestPermissionPromptStale:
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_p5_answered_y_agent_idle(self, mock_Zellij):
        """P5: User answered y, agent ran tool, now idle again."""
        mock_Zellij.get_history.return_value = load_fixture("kiro_cli_permission_stale_answered.txt")
        provider = make_provider("cao-workspace-expert")
        status = provider.get_status()
        assert status != TerminalStatus.WAITING_USER_ANSWER

    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_p6_long_response_instead_of_ynt(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_p7_rerendered_prompts_then_answered(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_stale_single_prompt_answered(self, mock_Zellij):
...
class TestNonPermissionCases:
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_n1_plain_idle(self, mock_Zellij):
        """N1: Plain idle, no permission prompt."""
        mock_Zellij.get_history.return_value = "[developer] 22% λ > "
        provider = make_provider("developer")
        assert provider.get_status() == TerminalStatus.IDLE

    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_n2_idle_trailing_text(self, mock_Zellij):
        """N2: Idle with trailing text after prompt."""
        mock_Zellij.get_history.return_value = "[developer] 24% λ > send message back to supervisor?"
        provider = make_provider("developer")
        assert provider.get_status() == TerminalStatus.IDLE

    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_n3_idle_what_would_you_like(self, mock_Zellij):
        """N3: Idle with 'What would you like to do next?' trailing text."""
        mock_Zellij.get_history.return_value = "[developer] 11% > What would you like to do next?"
        provider = make_provider("developer")
        assert provider.get_status() == TerminalStatus.IDLE

    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_n4_running_tool(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_n6_completed_response(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_n9_message_received(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_empty_output(self, mock_Zellij):
...
class TestPermissionPromptEdgeCases:
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_permission_same_line_as_idle(self, mock_Zellij):
        """Original fixture format: [y/n/t]: and idle prompt on same line."""
        mock_Zellij.get_history.return_value = "Allow this action? [y/n/t]: [developer] 10% λ > "
        provider = make_provider("developer")
        assert provider.get_status() == TerminalStatus.WAITING_USER_ANSWER

    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_multiple_active_prompts_last_unanswered(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_permission_with_ansi_codes(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_no_permission_prompt_in_output(self, mock_Zellij):
        """No permission prompt at all — should not affect idle detection."""
        mock_Zellij.get_history.return_value = "> Here is my response\n\n" "[developer] 22% λ > "
        provider = make_provider("developer")
        assert provider.get_status() == TerminalStatus.COMPLETED

    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_real_ansi_active_trailing_text(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_real_ansi_active_injection(self, mock_Zellij):
    ...
    @patch("cli_agent_orchestrator.providers.kiro_cli.zellij_client")
    def test_real_ansi_stale_answered_y(self, mock_Zellij):
