...
class TestQCliProviderInitialization:
    ...
    @patch("cli_agent_orchestrator.providers.q_cli.wait_until_status")
    @patch("cli_agent_orchestrator.providers.q_cli.zellij_client")
    def test_initialize_q_cli_timeout(self, mock_Zellij, mock_wait_status, mock_wait_shell):
...
class TestQCliProviderStatusDetection:
    ...
    def test_get_status_completed(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = load_fixture("q_cli_completed_output.txt")
    ...
    def test_get_status_processing(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = load_fixture("q_cli_processing_output.txt")
    ...
    def test_get_status_waiting_user_answer(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = load_fixture("q_cli_permission_output.txt")
    ...
    def test_get_status_error(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = load_fixture("q_cli_error_output.txt")
...
class TestQCliProviderHandoffScenarios:
    ...
    def test_handoff_successful_status(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = load_fixture("q_cli_handoff_successful.txt")
    ...
    def test_handoff_error_status(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = load_fixture("q_cli_handoff_error.txt")
    ...
    def test_handoff_with_permission_prompt(self, mock_Zellij):
        ...
        mock_Zellij.get_history.return_value = load_fixture("q_cli_handoff_with_permission.txt")
